...
public class Dl_Sua_ThucDon extends javax.swing.JDialog {
    private GetDataThucDon getthucdon = new GetDataThucDon();
    private GetDataLoai getloai=new GetDataLoai();
    Vector<ThucDon> td ;
    String MaMon;
    public Dl_Sua_ThucDon(java.awt.Frame parent, String mamon) {
        initComponents();
        MaMon = mamon;
        td = getthucdon.GetThucDonByMa(mamon);
        Fillcbb();
    ...
    private void Fillcbb() {
        Vector Vcbb = getloai.GetNhomMon();
        ...
        if (Vcbb != null) {
            ...
            }//set vị trí ptu dc chọn theo mã loại
        } else {
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Insert = getthucdon.UpdateThucDon(mon);
        if(Insert == 0){
            JOptionPane.showMessageDialog(null, "Sửa không thành công!");
            return;
        }
        Jp_QLThucDon.td.FillTable(MaNhom);// update dữ liệu bên qli
        Jp_QLThucDon.td.updateUI();
        try{
            jpThucDon.td.FillLoai();// update menu
