...
public class Dl_Them_ThucDon extends javax.swing.JDialog {
    ...
    private GetDataLoai loai = new GetDataLoai();

    public Dl_Them_ThucDon(java.awt.Frame parent) {
        initComponents();
        Fillcbb();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Insert = menu.InsertThucDon(td);
        if (Insert == 0) {
        ...
        Jp_QLThucDon.td.FillTable(MaNhom);// update dữ liệu món vừa add vào theo mã nhóm
        Jp_QLThucDon.td.updateUI();//update gd
        try {
            jpThucDon.td.FillLoai();// update menu gọi món
    ...
    private void txtGiaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGiaKeyReleased
        try {
            if (Integer.parseInt(txtGia.getText()) <= 0) {
                JOptionPane.showMessageDialog(null, "Giá món phải lớn hơn 0");
            }
        } catch (Exception ex) {
            txtGia.setText("");
        }
