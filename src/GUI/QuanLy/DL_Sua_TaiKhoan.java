...
public class DL_Sua_TaiKhoan extends javax.swing.JDialog {
    GetDataTaiKhoan user=new GetDataTaiKhoan();

    int ID;
    public DL_Sua_TaiKhoan(java.awt.Frame parent,int id) {
        initComponents();
        ID = id;
        TaiKhoan b = user.GetTaiKhoan(id);
    ...
    private void txtlvKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtlvKeyReleased
        try{
           if(Integer.parseInt(txtlv.getText()) !=2 && Integer.parseInt(txtlv.getText())!=1);
            {
                JOptionPane.showMessageDialog(null, "Level chỉ có 1 và 2!");
            }
        }catch(Exception e){
            txtlv.setText("");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int in = user.UpdateTK(tk);
        if(in > 0){
            Jp_QLTaiKhoan.qlitk.FillTable();
            Jp_QLTaiKhoan.qlitk.updateUI();
