...
public class DLQl_Them_Ban extends javax.swing.JDialog {
    private  GetDataBan ban=new GetDataBan();

    public DLQl_Them_Ban(java.awt.Frame parent) {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Jp_QLBan.B.FillTable();//update bên qli ban
        Jp_QLBan.B.updateUI();
        try{
            jpBanHang.bh.FillBan();// update bên bán hàng
