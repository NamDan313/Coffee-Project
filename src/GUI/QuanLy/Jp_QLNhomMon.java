...
public class Jp_QLNhomMon extends javax.swing.JPanel {
    GetDataLoai get=new GetDataLoai();
    ...
    public void FillTable() {
        Vector<Loai> arrTable = get.GetLoai();
    ...
    private void bntThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemActionPerformed
        DLQl_Them_Loai l = new DLQl_Them_Loai(Run.homepage);
        l.setVisible(true);
    ...
    private void bntSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaActionPerformed
        ...
        if(select<0){
            ...
            DLQl_Sua_Loai sua = new DLQl_Sua_Loai(Run.homepage, manhom);
            sua.setVisible(true);
        }
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        int selectedRow = tbNhomMon.getSelectedRow();

        if (selectedRow <= 0) {
            JOptionPane.showMessageDialog(null, "Bạn chưa chọn nhóm nào !");
        } else {
            String sp = "";
                String ma = (String) tbNhomMon.getValueAt(selectedRow, 0);
                String tennhom = (String) tbNhomMon.getValueAt(selectedRow, 1);

                sp += tennhom + "\n";
            int qs;
            qs = JOptionPane.showConfirmDialog(null, "Xóa nhóm: \n " + sp, "Xóa nhóm", JOptionPane.YES_NO_OPTION);
            if (qs == JOptionPane.YES_OPTION) {
                boolean xoa = get.DeleteNhom(ma);

                if (xoa == true) {
                    FillTable();// cập nhật thông tin
                    try{
                        Jp_QLThucDon.td.Fillcbb();//cập nhật dữ liệu ở jcombobox bên qlthucdon
                        Jp_QLThucDon.td.FillTable(null);//cập nhật dữ liệu ở table bên qlithucdon
                        Jp_QLThucDon.td.updateUI();//cập nhật gd
                        jpThucDon.td.FillLoai();// cập nhật dữ liệu bên jpthucdon
    ...
    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        Vector<Loai> arrTable = get.SearchLoai(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
