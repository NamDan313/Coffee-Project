...
public class Jp_QLBan extends javax.swing.JPanel {
    ...
    public void FillTable() {
        Vector<Ban> arrTable = getinfoban.GetBan(0);
    ...
    private void bntThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemActionPerformed
        DLQl_Them_Ban ban = new DLQl_Them_Ban(Run.homepage);
        ban.setVisible(true);
    ...
    private void bntSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaActionPerformed
        ...
        if(select<0){
            ...
            DLQl_Sua_Ban sua = new DLQl_Sua_Ban(Run.homepage, MaBan);
            sua.setVisible(true);
        }
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        ...
        if (selectedRow<= 0) {
            JOptionPane.showMessageDialog(null, "Bạn chưa chọn bàn muốn xóa !");
        } else {
            String sp = "";
            ...
            if (qs == JOptionPane.YES_OPTION) {
                boolean xoa = getinfoban.DeleteBan(ma);

                if (xoa == true) {
                    Jp_QLBan.B.FillTable();// load để cập nhật thông tin 
                    Jp_QLBan.B.updateUI();// cập nhật giao diện bằng giá trị hiện tại
                    try{
                        jpBanHang.bh.FillBan();// cập nhật thông tin bên phần bán hàng
    ...
    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        Vector<Ban> arrTable = getinfoban.SearchBan(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
