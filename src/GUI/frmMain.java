...
import GUI.Home.JpHome;
import GUI.QuanLy.JpQuanLy;
...
public final class frmMain extends javax.swing.JFrame 
{
    ...
    public void fill(){
        home = new JpHome();
        jpLayout.add(home);
        jpLayout.updateUI();// cập nhận giao diện bằng giá trị hiện tại
    ...
    public void reloadPanel(int i) {
        jpLayout.removeAll();// xóa hết những gì đang có trên jpanel
        switch (i) {
            case 1:
                if (banhang == null) {
