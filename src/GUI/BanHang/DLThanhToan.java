...
public class DLThanhToan extends javax.swing.JDialog {
    ...
    GetDataHoaDon hoadon = new GetDataHoaDon();
    GetDataBan ban = new GetDataBan();
    int tong, MaHD;
    int MaBan;

    public DLThanhToan(java.awt.Frame parent, int tongtien, String tenban, int maban, int mahd) {
        initComponents();
        tong = tongtien;
        MaHD = mahd;
        MaBan = maban;
    ...
    private void btnxacnhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxacnhanActionPerformed
        ...
        b.SetMaBan(MaBan);
        ban.UpDateTrangThaiBan(b);// thành 

        HoaDon hd = new HoaDon();
        hd.setTongTien(tong);
        hd.setMaHoaDon(MaHD);
        hoadon.ThanhToan(hd);//set trạng thái hđ thành 1 

        jpBanHang.bh.FillBan();// load để cập nhật thông tin
        JpGoiMon.gm.removeAll();//xóa các thành phần trong gp gọi món
        jpBanHang.bh.fillLb();//set GD jpbanhang như lúc đầu
        this.dispose();
