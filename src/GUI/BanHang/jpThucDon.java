...
public class jpThucDon extends javax.swing.JPanel {
    // lấy thông tin các nhóm món
    GetDataLoai getinfoloai = new GetDataLoai();
    // lấy thông tin các món ăn để đẩy lên menu
    GetDataThucDon getinfothucdon=new GetDataThucDon();
    public String gioden, tenban;
    public int maban;
    public Vector<ThucDon> arrdsmon;//lấy thông tin các loại nước
    DecimalFormat chuyentien = new DecimalFormat("#,###,###");
    public static jpThucDon td;
    public void FillLoai(){
        Vector<Loai> arrLoai = getinfoloai.GetLoai();//gán thong tin các loại nướcở mysql
        if(arrLoai != null){
            JButton btn;
            ...
            for(Loai l : arrLoai){
                    ...
                    btn.addMouseListener(new MouseAdapter() {
                        @Override
                        public void mousePressed(MouseEvent e) {// khi click chuột 
                            lblNhom.setText("    Nhóm "+l.GetTenLoai());
                            lblNhom.setBackground(Color.decode(l.GetMauSac()));
                            Vector<ThucDon> arrThucDon = getinfothucdon.GetThucDon(l.GetMaLoai());
                            jpChonMon.removeAll();
                            jpChonMon.updateUI();
                            if(arrThucDon != null){
